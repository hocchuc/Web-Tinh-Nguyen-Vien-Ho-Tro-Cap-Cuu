...
function parseMessage(message) {
	...
	} else if (jObj.flag == 'old_message') {
		// if the flag is 'old_message', send ms to new client
		var new_name = 'You';
	...
	else if (jObj.flag == 'secret_message') {
		// if the flag is 'secret_message', send ms to specific client
		var new_name = 'You';
