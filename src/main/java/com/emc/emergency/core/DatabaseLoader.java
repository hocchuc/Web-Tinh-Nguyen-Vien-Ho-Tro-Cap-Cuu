...
public class DatabaseLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        User user1 = new User(null,"hocanhchuc@gmail.com",user_type.findOne(2l), "123456",null,10.736774, 106.675690);
        user1.setIs_signup_volunteer(true);
        User user2 = new User(null,"trancaotri@gmail.com",user_type.findOne(2l), "123456",null,10.738545, 106.674767);
        user2.setIs_signup_volunteer(true);

        User user3 = new User(null,"diemhang@gmail.com",user_type.findOne(12l), "123456",null,10.741539, 106.677170);
        user3.setIs_signup_volunteer(true);

        User user4 = new User(null,"trantrungduong@gmail.com",user_type.findOne(12l), "123456",null,10.780040, 106.629250);
        user4.setIs_signup_volunteer(true);

        User user5 = new User(null,"truongminhhoang@gmail.com",user_type.findOne(22l), "123456",null,10.737681, 106.677192);
        User user6 = new User(null,"huynhthanhtrung@gmail.com",user_type.findOne(22l), "123456",null,10.741539, 106.677170);
        User user7 = new User(null,"trankimchi@gmail.com",user_type.findOne(22l), "123456",null,10.749258, 106.593523);
        user7.setIs_signup_volunteer(true);
        user.save(user1);
        user.save(user2);
        user.save(user3);
        user.save(user4);
        ...
        user.save(user7);
            ...
            Accident accident1 = new Accident(null,user.findOne(2l),"Gãy lưng",new SimpleDateFormat("dd/MM/yyyy 'at' hh:mm:ss a").parse("10/06/2017 at 10:10:15 AM"),10.737994,106.679003,"Pending","87 Ông Ích Khiêm, phường 10, Quận 11, Hồ Chí Minh, Việt Nam",null,false);
        accident.save(accident1);

        Accident accident2 = new Accident(null,user.findOne(12l),"Té xe ",new SimpleDateFormat("dd/MM/yyyy 'at' hh:mm:ss a").parse("11/06/2017 at 02:10:15 PM"),10.781785,106.643036,"Pending","541 Âu Cơ, Phú Trung, Tân Phú, Hồ Chí Minh",null,false);
        accident.save(accident2);

        Accident accident3 = new Accident(null,user.findOne(32l),"Chó cắn",new SimpleDateFormat("dd/MM/yyyy 'at' hh:mm:ss a").parse("11/06/2017 at 02:10:15 PM"),10.799555,106.637219,"Pending","15-16 Âu Cơ, phường 14, Tân Phú, Hồ Chí Minh",null,false);
        ...
        //accident.save(accident6);
            ...
            Personal_Infomation p1 = new Personal_Infomation(null,"https://firebasestorage.googleapis.com/v0/b/fir-demo-chat-spring.appspot.com/o/images%2F1.PNG?alt=media&token=e485b8b4-3886-421d-90e8-ae461bcce17b","Chúc Anh Học",true,new SimpleDateFormat("dd/MM/yyyy").parse("10/09/1995"),"252956865l","Từ Dũ","0903562332","Phu Tho Hoa","chucanhhoc@gmail.com",user.findOne(2l));
        personal_infoRepository.save(p1);

        Personal_Infomation p2 = new Personal_Infomation(null,"https://firebasestorage.googleapis.com/v0/b/fir-demo-chat-spring.appspot.com/o/images%2F2.jpg?alt=media&token=d9703039-e182-4cbc-91fc-90a069fd5b7c","Trần Cao Trí",true,new SimpleDateFormat("dd/MM/yyyy").parse("20/06/1995"),"252416865l","115","0909999119","Thach Lam","trancaotri@gmail.com",user.findOne(12l));
        personal_infoRepository.save(p2);

        Personal_Infomation p3 = new Personal_Infomation(null,"https://firebasestorage.googleapis.com/v0/b/fir-demo-chat-spring.appspot.com/o/images%2F3.png?alt=media&token=881a65e0-6e88-4b74-828d-f06372fc8705","Lê Diễm Hàng",false,new SimpleDateFormat("dd/MM/yyyy").parse("19/06/1995"),"2524456865l","Chương Dương","0909999113","Hiền Vương","diemhang@gmail.com",user.findOne(22l));
        personal_infoRepository.save(p3);

        Personal_Infomation p4 = new Personal_Infomation(null,"https://firebasestorage.googleapis.com/v0/b/fir-demo-chat-spring.appspot.com/o/images%2F4.jpg?alt=media&token=efb6679f-f8fa-4d34-918a-278fbd51d549","Trần Trung Dương",false,new SimpleDateFormat("dd/MM/yyyy").parse("20/16/1995"),"25244568756","Bệnh Viện Quận 6","0909999213","Cao Lỗ ","trantrungduong@gmail.com",user.findOne(32l));
        personal_infoRepository.save(p4);

        Personal_Infomation p5 = new Personal_Infomation(null,"https://firebasestorage.googleapis.com/v0/b/fir-demo-chat-spring.appspot.com/o/images%2F5.jpg?alt=media&token=9c4ae55c-e74a-4eba-a856-254f9d922298","Trương Minh Hoàng",false,new SimpleDateFormat("dd/MM/yyyy").parse("30/08/1995"),"25244568123","Công ty GPS","0909999222","Bình Long","truongminhhoang@gmail.com",user.findOne(42l));
        personal_infoRepository.save(p5);

        Personal_Infomation p6 = new Personal_Infomation(null,"https://firebasestorage.googleapis.com/v0/b/fir-demo-chat-spring.appspot.com/o/images%2F6.jpg?alt=media&token=af87f071-4e0c-447c-82fe-be840aea9098","Huỳnh Thanh Trung",false,new SimpleDateFormat("dd/MM/yyyy").parse("20/8/1995"),"25244568333","Công ty Technik","0909999654","Long An","huynhthanhtrung@gmail.com",user.findOne(52l));
        personal_infoRepository.save(p6);

        Personal_Infomation p7 = new Personal_Infomation(null,"https://firebasestorage.googleapis.com/v0/b/fir-demo-chat-spring.appspot.com/o/images%2F8.jpg?alt=media&token=43c637d2-deb8-4cce-9c60-71a2edbd0733","Trần Kim Chi",false,new SimpleDateFormat("dd/MM/yyyy").parse("12/2/1995"),"25298568333","Bệnh viện 115","0909999665","Cà Mau","trankimchi@gmail.com",user.findOne(62l));
        personal_infoRepository.save(p7);


        Medical_Info m1 = new Medical_Info(null,personal_infoRepository.findOne(2L),"Panadol",1,"Thuốc đau đầu");
        medical_infoRepository.save(m1);
        Medical_Info m1_2 = new Medical_Info(null,personal_infoRepository.findOne(12L),"Đau đầu",2,"Đau đầu ");
        medical_infoRepository.save(m1_2);

        Medical_Info m2 = new Medical_Info(null,personal_infoRepository.findOne(22L),"bioka",1,"thuoc chua ung thu");
        medical_infoRepository.save(m2);

        Medical_Info m2_2 = new Medical_Info(null,personal_infoRepository.findOne(32L),"Ung Thu",2,"ung thu giai doan 1");
        ...
        Accident_Detail accident_detail1 = new Accident_Detail(null,new SimpleDateFormat("dd/MM/yyyy").parse("30/08/2017"),user.findOne(1L),accident.findOne(2L),action_typeRepository.findOne(2L));

        Accident_Detail accident_detail2 = new Accident_Detail(null,new SimpleDateFormat("dd/MM/yyyy").parse("30/08/2017"),user.findOne(12L),accident.findOne(2L),action_typeRepository.findOne(2L));
