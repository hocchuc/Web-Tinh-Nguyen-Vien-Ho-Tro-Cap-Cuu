...
//
        ...
        Accident accident4 = new Accident(null,user.findOne(3l),"Té cầu thang",new SimpleDateFormat("dd/MM/yyyy 'at' hh:mm:ss a").parse("11/06/2017 at 02:10:15 PM"),Double.parseDouble("10.783994"),Double.parseDouble("106.636266"),"Pending","763 Lũy Bán Bích Hoà Thạnh Tân Phú Hồ Chí Minh",null, false );
        accident.save(accident4);

        Accident accident5 = new Accident(null,user.findOne(2l),"Đau tim",new SimpleDateFormat("dd/MM/yyyy 'at' hh:mm:ss a").parse("11/06/2017 at 02:10:15 PM"),Double.parseDouble("10.7123"),Double.parseDouble("106.613"),"Pending","Số 454 Âu Cơ Tân Binh Hồ Chí Minh", null, false);
        accident.save(accident5);

        Accident accident6 = new Accident(null,user.findOne(2l),"Té xe",new SimpleDateFormat("dd/MM/yyyy 'at' hh:mm:ss a").parse("11/06/2017 at 02:10:15 PM"), Double.parseDouble("10.7142"),Double.parseDouble("106.644"),"Pending","Số 433 Âu Cơ Tân Binh Hồ Chí Minh",null, false);
